  ...
  <div class="home">
        <div class="header-blue">
            <nav class="navbar navbar-dark navbar-expand-md navigation-clean-search">
                <div class="container">
                  <a class="navbar-brand" href="/"> SolveIt </a>
                  <button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1">
                    ...
                    <div class="collapse navbar-collapse"
                        ...
                        </form><span class="navbar-text"> <router-link to="/login" class="login">Log In</router-link></span>
                        <router-link to="/signup" class="btn btn-light action-button" role="button">Sign Up</router-link></div>
                </div>
            </nav>
        </div>
  </div>
